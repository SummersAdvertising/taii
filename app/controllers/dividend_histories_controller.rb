class DividendHistoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @dividend_history.save
        format.html { redirect_to @dividend_history, notice: 'Dividend history was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @dividend_history.update(dividend_history_params)
        format.html { redirect_to @dividend_history, notice: 'Dividend history was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dividend_histories_url }
      format.json { head :no_content }
    end
  end
